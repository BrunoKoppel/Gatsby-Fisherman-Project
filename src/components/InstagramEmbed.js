...
function InstagramEmbed() {
    return (
        <blockquote className="instagram-media" data-instgrm-captioned data-instgrm-permalink="https://www.instagram.com/p/B6uf6mPlwRb" data-instgrm-version={12} style={{background: '#FFF', border: 5, borderRadius: '3px', boxShadow: '0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15)', margin: '1px', maxWidth: '540px', minWidth: '326px', padding: 0, width: 'calc(100% - 2px)'}}>
            <div style={{padding: '16px'}}> 
                <a href="https://www.instagram.com/p/B6uf6mPlwRb" style={{background: '#FFFFFF', lineHeight: 0, padding: '0 0', textAlign: 'center', textDecoration: 'none', width: '100%'}} > 
                ...
                <p style={{margin: '8px 0 0 0', padding: '0 4px'}}> 
                    <a href="https://www.instagram.com/p/B6uf6mPlwRb" style={{color: '#000', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px', textDecoration: 'none', wordWrap: 'break-word'}}>
                    Built a loop of lights with changeable speed and some european styled traffic lights. We out here learning to build circuits with #arduino #arduinoproject
                    </a>
                </p> 
                <p style={{color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px', marginBottom: 0, marginTop: '8px', overflow: 'hidden', padding: '8px 0 7px', textAlign: 'center', textOverflow: 'ellipsis', whiteSpace: 'nowrap'}}>
                    A post shared by 
                    <a href="https://www.instagram.com/bruno_koppel" style={{color: '#c9c8cd', fontFamily: 'Arial,sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px'}}> 
                    Bruno Koppel
                    </a> 
                    (@bruno_koppel) on 
                    <time style={{fontFamily: 'Arial,sans-serif', fontSize: '14px', lineHeight: '17px'}} dateTime="2019-12-31T06:21:03+00:00">
                    Dec 30, 2019 at 10:21pm PST
                    </time>
                </p>
            </div>
        </blockquote>
